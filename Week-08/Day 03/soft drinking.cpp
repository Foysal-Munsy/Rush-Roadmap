...
void solve()
{
    ...
    int num_toasts_drink = total_drink / n_l;
    int num_toasts_lime = total_lime_slices;
    int num_toasts_salt = p / np;
    int min_toasts = min({num_toasts_drink, num_toasts_lime, num_toasts_salt});
    cout << min_toasts / n << nl;
}
int main()
{
    Code By Foysal
